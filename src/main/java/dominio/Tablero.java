...
public class Tablero extends VBox implements PropiedadesCelda {
    ...
    private void rellenarFiguras() {
        ...
        celdas[3][3].establecerFigura(REINA, j1.getNombre());
        celdas[1][1].establecerFigura(PEON, j1.getNombre());
        celdas[3][1].establecerFigura(PEON, j1.getNombre());
        celdas[1][3].establecerFigura(PEON, j1.getNombre());
        celdas[6][6].establecerFigura(PEON, j1.getNombre());
